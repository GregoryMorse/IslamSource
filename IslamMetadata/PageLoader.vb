...
Public Class Arabic
    ...
    Public Shared SimpleEnhancedScript As RuleTranslation() = { _
        ...
        New RuleTranslation With {.Rule = "TrailingAlef", .Match = "(?<=(((?<!" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + "|" + MakeUniRegEx(ArabicLetterWawWithHamzaAbove) + "|" + MakeUniRegEx(ArabicLetterWaw) + "|(" + MakeUniRegEx(ArabicLetterTeh) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterAlefWasla) + ")" + MakeUniRegEx(ArabicLetterDal) + "|" + MakeUniRegEx(ArabicLetterAin) + "|" + MakeUniRegEx(ArabicLetterReh) + "|" + MakeUniRegEx(ArabicLetterGhain) + "|" + MakeUniRegEx(ArabicLetterBeh) + "|" + MakeUniRegEx(ArabicLetterLam) + "|" + MakeUniRegEx(ArabicLetterNoon) + ")" + MakeUniRegEx(ArabicSukun) + "|(?<!(" + MakeUniRegEx(ArabicLetterDal) + "|" + MakeUniRegEx(ArabicLetterReh) + "|" + MakeUniRegEx(ArabicLetterTeh) + "|" + MakeUniRegEx(ArabicLetterHeh) + "|" + MakeUniRegEx(ArabicLetterThal) + "|" + MakeUniRegEx(ArabicLetterJeem) + "|" + MakeUniRegEx(ArabicLetterKaf) + "|" + MakeUniRegEx(ArabicLetterQaf) + "|" + MakeUniRegEx(ArabicLetterHamza) + "|" + MakeUniRegEx(ArabicLetterBeh) + "|" + MakeUniRegEx(ArabicLetterNoon) + "|" + MakeUniRegEx(ArabicLetterTah) + "|" + MakeUniRegEx(ArabicLetterDad) + "|" + MakeUniRegEx(ArabicLetterMeem) + MakeUniRegEx(ArabicLetterLam) + ")" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterAlef) + "|(?<!" + MakeUniRegEx(ArabicTatweel) + "|" + MakeUniRegEx(ArabicLetterQaf) + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")(" + MakeUniRegEx(ArabicLetterAin) + "|" + MakeUniRegEx(ArabicLetterSeen) + "|" + MakeUniRegEx(ArabicLetterFeh) + "|" + MakeUniRegEx(ArabicLetterNoon) + "|" + MakeUniRegEx(ArabicLetterMeem) + "|" + MakeUniRegEx(ArabicLetterQaf) + "|" + MakeUniRegEx(ArabicLetterDal) + "|" + MakeUniRegEx(ArabicLetterHamza) + "|" + MakeUniRegEx(ArabicLetterReh) + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicLetterLam) + "|" + MakeUniRegEx(ArabicLetterThal) + "|" + MakeUniRegEx(ArabicLetterTah) + "|" + MakeUniRegEx(ArabicLetterBeh) + "|" + MakeUniRegEx(ArabicLetterTeh) + "))(?<!" + MakeUniRegEx(ArabicShadda) + ")" + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicMaddahAbove) + "?)" + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicSmallHighRoundedZero) + "|" + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicSmallHighRoundedZero) + MakeUniRegEx(ArabicLetterAlefMaksura) + "|(?<=(" + MakeUniRegEx(ArabicLetterLam) + "|" + MakeUniRegEx(ArabicLetterDal) + "|" + MakeUniRegEx(ArabicLetterReh) + ")" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterWawWithHamzaAbove) + "(" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicDammatan) + MakeUniRegEx(ArabicSmallLowMeem) + "))" + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicSmallHighRoundedZero), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) Match.Value.Remove(0, 1)}, _
        ...
        New RuleTranslation With {.Rule = "AlefMaksuraToYeh", .Match = "(" + MakeUniRegEx(ArabicSmallHighRoundedZero) + "|" + MakeUniRegEx(ArabicSukun) + "|" + MakeUniRegEx(ArabicKasra) + ")" + MakeUniRegEx(ArabicLetterAlefMaksura) + "|(" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")" + MakeUniRegEx(ArabicLetterAlefMaksura) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlefMaksura) + "(" + MakeUniRegEx(ArabicSukun) + "|" + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicKasra) + ")", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) Match.Value.Remove(1, 1).Insert(1, ArabicLetterYeh)}, _
        New RuleTranslation With {.Rule = "SmallSadAboveHamzaWasl", .Match = MakeUniRegEx(ArabicLetterAlefWasla) + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicShadda) + "(?!" + MakeUniRegEx(ArabicFatha) + "(" + MakeUniRegEx(ArabicLetterThal) + "|" + MakeUniRegEx(ArabicLetterTeh) + "))", _
        ...
        New RuleTranslation With {.Rule = "SmallSadAboveHamzaWasl", .Match = MakeUniRegEx(ArabicLetterAlefWasla), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterAlef)}, _
        New RuleTranslation With {.Rule = "AlefMaksura", .Match = "(?<=" + MakeUniRegEx(ArabicLetterGhain) + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterAlef) + "(?=($| ))", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterAlefMaksura)}, _
        New RuleTranslation With {.Rule = "Alef", .Match = "(?<=(^| )(" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterFeh) + ")" + MakeUniRegEx(ArabicFatha) + ")(?=" + MakeUniRegEx(ArabicLetterSeen) + MakeUniRegEx(ArabicSukun) + ")", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterAlef)}, _
        New RuleTranslation With {.Rule = "HamzaAlefEnding", .Match = MakeUniRegEx(ArabicLetterHamza) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "(?=($| ))", _
        ...
        New RuleTranslation With {.Rule = "RehAlefEnding", .Match = "(?<=" + MakeUniRegEx(ArabicLetterReh) + ")" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "(?=($| ))", _
        ...
        New RuleTranslation With {.Rule = "AlefWithHamzaAbove", .Match = "(?<= |^|" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterHamza) + "(?=" + MakeUniRegEx(ArabicFatha) + ")|(" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")" + MakeUniRegEx(ArabicHamzaAbove) + "|(?<=" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterWawWithHamzaAbove) + "(?!" + MakeUniRegEx(ArabicDamma) + "\b)|(?<=" + MakeUniRegEx(ArabicSukun) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "(?=" + MakeUniRegEx(ArabicFatha) + ")", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterAlefWithHamzaAbove)}, _
        New RuleTranslation With {.Rule = "WawWithHamzaAbove", .Match = "(?<=" + MakeUniRegEx(ArabicDamma) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove), _
        ...
        New RuleTranslation With {.Rule = "YehWithHamzaAbove", .Match = "((?<!" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "|(?<!" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterYeh) + "|" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicSukun) + ")" + MakeUniRegEx(ArabicLetterHamza) + ")(?=" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + "|" + MakeUniRegEx(ArabicSukun) + ")(?! |$)", _
        ...
        New RuleTranslation With {.Rule = "NonReadYeh", .Match = MakeUniRegEx(ArabicLetterYeh) + MakeUniRegEx(ArabicSmallHighRoundedZero), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) String.Empty}, _
        New RuleTranslation With {.Rule = "SuperscriptAlef", .Match = "(?<=" + MakeUniRegEx(ArabicFatha) + ")(" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterAlefMaksura) + ")" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + "(?! |$)", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterAlef)}, _
        New RuleTranslation With {.Rule = "SuperscriptAlef", .Match = "(?<=(?<!( |^)" + MakeUniRegEx(ArabicLetterHeh) + "|" + MakeUniRegEx(ArabicLetterHah) + MakeUniRegEx(ArabicSukun) + MakeUniRegEx(ArabicLetterMeem) + "|(^| )(((" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterFeh) + ")" + MakeUniRegEx(ArabicFatha) + ")?((" + MakeUniRegEx(ArabicLetterKaf) + "|" + MakeUniRegEx(ArabicLetterFeh) + "|" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + ")" + MakeUniRegEx(ArabicFatha) + "|(" + MakeUniRegEx(ArabicLetterBeh) + "|" + MakeUniRegEx(ArabicLetterLam) + ")" + MakeUniRegEx(ArabicKasra) + "))?" + MakeUniRegEx(ArabicLetterThal) + "|" + MakeUniRegEx(ArabicLetterAlefWithHamzaBelow) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterLam) + "|(^| )(" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicSukun) + ")?" + MakeUniRegEx(ArabicLetterLam) + ")" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicTatweel) + "?)" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + "(?! |$|" + MakeUniRegEx(ArabicLetterThal) + "(" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterHeh) + MakeUniRegEx(ArabicKasra) + ")|" + MakeUniRegEx(ArabicLetterHeh) + "(" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicDammatan) + "|" + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterMeem) + MakeUniRegEx(ArabicSukun) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicFatha) + "(" + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicFatha) + ")?)( | $)|" + MakeUniRegEx(ArabicLetterYehWithHamzaAbove) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicFatha) + "( | $))", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterAlef)}, _
        New RuleTranslation With {.Rule = "Hamza", .Match = MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "|(?<=" + MakeUniRegEx(ArabicLetterAlef) + ")(" + MakeUniRegEx(ArabicLetterWawWithHamzaAbove) + "(?=(" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicDammatan) + ")($| ))|" + MakeUniRegEx(ArabicLetterYehWithHamzaAbove) + "(?=" + MakeUniRegEx(ArabicKasra) + "($| )))", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterHamza)}
        }
