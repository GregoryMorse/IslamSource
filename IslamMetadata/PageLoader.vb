...
Public Class TanzilReader
    ...
    Public Shared Sub CheckMutualExclusiveRules(bAssumeContinue As Boolean)
        ...
        Check = {{CachedData.GetPattern("PossibleMadd"), "madd"}, {"MaddahCatcher", "madd;;madd;optionalnotstop;optionalnotstop;;madd;optionalstop;optionalstop;;madd;optionalnotstop;optionalnotstop"}, {"MaddahNormal", ";madd;madd;madd;madd;madd;madd;madd;madd;;madd;madd;madd;optionalstop|optionalnotstop;optionalnotstop;optionalnotstop;;;madd;;optionalnotstop;optionalnotstop;;madd;madd;optionalstop;optionalstop;;;;;madd;;optionalstop;optionalstop;;madd;madd;optionalnotstop;optionalnotstop;;madd;madd;;;;madd;madd;madd;;;;madd;;;madd;;;;madd;optionalstop;optionalstop;madd;optionalstop;optionalstop"}, {"MaddahExchange", ";madd;madd;optionalstop;optionalnotstop;optionalnotstop;;madd;;madd;;;;madd;;madd;optionalstop;optionalstop;;"}, {"MaddahEssentialConnected", ";madd;optionalstop|optionalnotstop;optionalnotstop;optionalnotstop;madd"}, {"MaddahPresentedSukun", ";madd;madd;optionalstop;optionalstop"}, {"MaddahEssentialConnectedPresentedSukun", ";madd;optionalstop;optionalstop"}, {"MaddahEssentialSeparate", "madd;optionalnotstop;optionalnotstop"}, {"MaddahObligatory", "madd"}}
        ...
        Check = {{CachedData.GetPattern("Yehs"), "yeh"}, {"NotYeh", "yeh;;yeh;;yeh;;yeh;;"}, {"MaddYeh", ";yeh;yeh"}, {"LeenYeh", ";yeh;;yeh"}, {"StrongYeh", ";yeh;;yeh;;yeh;;yeh;yeh;;yeh;;yeh;;yeh;;yeh"}}
        'Check = {{CachedData.GetPattern("Waws"), "waw"}, {"NotWaw", "waw;;waw;;waw;optionalnotstop;optionalnotstop;;optionalstop;optionalstop;waw"}, {"MaddWaw", ";waw"}, {"LeenWaw", ";waw;optionalstop;optionalstop;;optionalnotstop;optionalnotstop;waw"}, {"StrongWaw", ";optionalnotstop;optionalnotstop;waw;;waw;;waw;;waw;;optionalstop;optionalstop;waw"}}
        Dim IndexToVerse As Integer()() = Nothing
        Dim Text As String = QuranTextCombiner(IndexToVerse)
