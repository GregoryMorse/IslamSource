...
Public Class TanzilReader
    ...
    Public Shared Sub CheckMutualExclusiveRules(bAssumeContinue As Boolean)
        ...
        Check = {{CachedData.GetPattern("LeenMadd"), "madd"}, {"MaddahLeenCatcher", "madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;optionalnotstop;optionalnotstop;madd"}, {"MaddahLeen", ";madd;;;;madd;madd;optionalnotstop;optionalnotstop;madd;madd;optionalstop;optionalstop;madd;;;madd"}, {"MaddahLeenPresentedSukun", ";madd;madd;optionalstop;optionalstop"}}
        ...
        For MainCount = 1 To Check.GetLength(0) - 1
            ...
            For Count = 0 To Matches.Count - 1
                ...
                End If
            Next
            Debug.Print(CStr(Matches.Count - SieveCount))
        Next
        Dim Keys(CheckMatches.Keys.Count - 1) As Integer
        CheckMatches.Keys.CopyTo(Keys, 0)
        Array.Sort(Keys)
