...
Public Class Arabic
    ...
    Public Shared SimpleEnhancedScript As RuleTranslation() = { _
        ...
        New RuleTranslation With {.Rule = "Madda", .Match = MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicLetterSuperscriptAlef) + MakeUniRegEx(ArabicMaddahAbove) + "(?=" + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicSmallHighRoundedZero) + ")", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) String.Empty}, _
        New RuleTranslation With {.Rule = "Madda", .Match = MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicLetterSuperscriptAlef) + MakeUniRegEx(ArabicMaddahAbove) + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterAlefWithMaddaAbove) + " "},
        New RuleTranslation With {.Rule = "Madda", .Match = MakeUniRegEx(ArabicLetterHamza) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "|(?<=" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + MakeUniRegEx(ArabicFatha) + "(" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")", _
        ...
        New RuleTranslation With {.Rule = "SmallMeemIghlab", .Match = MakeUniRegEx(ArabicSmallHighMeemIsolatedForm) + "|" + MakeUniRegEx(ArabicSmallLowMeem), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) String.Empty}, _
        New RuleTranslation With {.Rule = "HamzaFatha", .Match = "(?<= |^)" + MakeUniRegEx(ArabicLetterHamza) + "(?=" + MakeUniRegEx(ArabicFatha) + ")|" + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicHamzaAbove) + "|(?<=" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterWawWithHamzaAbove) + "|(?<=" + MakeUniRegEx(ArabicSukun) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "(?=" + MakeUniRegEx(ArabicFatha) + ")", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterAlefWithHamzaAbove)}, _
        New RuleTranslation With {.Rule = "HamzaKasra", .Match = MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicDamma) + CStr(ArabicLetterWawWithHamzaAbove)}, _
        New RuleTranslation With {.Rule = "HamzaKasra", .Match = MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterHamza) + MakeUniRegEx(ArabicKasra), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) Match.Value.Remove(1, 1).Insert(1, ArabicLetterAlefWithHamzaBelow)}, _
        New RuleTranslation With {.Rule = "HamzaKasra", .Match = "(" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "|(?<!" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicSukun) + ")" + MakeUniRegEx(ArabicLetterHamza) + ")(" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + ")(?! |$)", _
