...
Public Class Arabic
    ...
    Public Shared RulesOfRecitationRegEx As RuleMetadataTranslation() = { _
        ...
        New RuleMetadataTranslation With {.Rule = "FathaAlefMaksura", .Match = "(" + ArabicData.MakeUniRegEx(ArabicData.ArabicFatha) + "|" + ArabicData.MakeUniRegEx(ArabicData.ArabicFathatan) + "(?:" + ArabicData.MakeUniRegEx(ArabicData.ArabicSmallLowMeem) + "|" + ArabicData.MakeUniRegEx(ArabicData.ArabicSmallHighMeemIsolatedForm) + ")?)(" + ArabicData.MakeUniRegEx(ArabicData.ArabicLetterAlefMaksura) + ")(?=\s+|\s*$|" + ArabicData.MakeUniRegEx(ArabicData.ArabicLetterSuperscriptAlef) + ")", _
