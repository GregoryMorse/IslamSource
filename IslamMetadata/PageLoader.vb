...
Public Class TanzilReader
    ...
    Public Shared Sub CheckMutualExclusiveRules(bAssumeContinue As Boolean)
        ...
        Check = {{CachedData.GetPattern("LeenMadd"), "madd"}, {"MaddahLeenCatcher", "madd;optionalnotstop;optionalnotstop;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd"}, {"MaddahLeen", ";madd;;;;madd;madd;optionalnotstop;optionalnotstop;madd;madd;optionalstop;optionalstop;madd;;;madd"}, {"MaddahLeenPresentedSukun", ";madd;madd;optionalstop;optionalstop"}}
