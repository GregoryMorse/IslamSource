...
Public Class Arabic
    ...
    Public Shared SimpleEnhancedScript As RuleTranslation() = { _
        ...
        New RuleTranslation With {.Rule = "SmallMeemIghlab", .Match = MakeUniRegEx(ArabicSmallHighMeemIsolatedForm) + "|" + MakeUniRegEx(ArabicSmallLowMeem), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) String.Empty}, _
        New RuleTranslation With {.Rule = "HamzaKasra", .Match = "(?<!" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + ")(" + MakeUniRegEx(ArabicLetterHamza) + "|" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + ")(" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicDamma) + ")(?! |$)", _
