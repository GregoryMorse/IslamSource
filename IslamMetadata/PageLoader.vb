...
Public Class Arabic
    ...
    Public Shared Function IsDiacriticJS() As String
        Return "function isDiacritic(index) { return (" + String.Join("||", Array.ConvertAll(Arabic.RecitationDiacritics, Function(C As Char) "parseInt(arabicLetters[index].Symbol, 10) === 0x" + Hex(AscW(C)))) + "); }"
    End Function
    ...
    Public Shared Function GetTransliterateNumberJS() As String()
        Return New String() {"javascript: doTransliterateNum();", String.Empty, GetArabicSymbolJSArray(), GetTransliterateGenJS(), _
                             "var arabicOrdinalNumbers = " + Utility.MakeJSArray(ArabicOrdinalNumbers) + ";", _
    ...
    Public Shared Function GetTransliterateJS() As String()
        Return New String() {"javascript: doTransliterateDisplay();", String.Empty, GetArabicSymbolJSArray(), GetTransliterateGenJS(), GetDiacriticJS(), GetTransliterateNumberJS(), _
