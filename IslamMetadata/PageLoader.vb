            ...
            Function(Match As System.Text.RegularExpressions.Match)
                If bAll Then
                    ...
                    If GetGroup(Match.Groups(1).Value).Length <> 0 Then
                        Return ArabicData.MakeRegMultiEx(Array.ConvertAll(GetGroup(Match.Groups(1).Value), Function(Str As String) ArabicData.MakeUniRegEx(Arabic.TransliterateFromBuckwalter(Str))))
                    End If
                End If
...
Public Class TanzilReader
    ...
    Public Shared Sub CheckMutualExclusiveRules(bAssumeContinue As Boolean)
        ...
        'Check = {{CachedData.GetPattern("Yehs"), "yeh"}, {"NotYeh", "yeh;;yeh;;yeh;;yeh;;;;yeh;optionalnotstop;optionalnotstop;yeh;optionalstop;optionalstop"}, {"MaddYeh", ";yeh;optionalstop;optionalstop;yeh;optionalnotstop;optionalnotstop"}, {"LeenYeh", ";yeh;;yeh"}, {"StrongYeh", ";yeh;;yeh;;yeh;;yeh;yeh;;yeh;;yeh;;yeh;;yeh;;yeh;;yeh"}}
