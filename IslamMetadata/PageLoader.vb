...
Public Class TanzilReader
    ...
    Public Shared Sub CheckMutualExclusiveRules(bAssumeContinue As Boolean)
        ...
        Check = {{CachedData.GetPattern("PossibleMadd"), "madd"}, {"MaddahCatcher", "madd;;madd;optionalnotstop;optionalnotstop;;madd;optionalstop;optionalstop;;madd;optionalnotstop;optionalnotstop;;;madd;madd;optionalnotstop;optionalnotstop;madd;optionalnotstop;optionalnotstop;optionalnotstop;optionalnotstop;;madd;optionalnotstop;optionalnotstop;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd"}, {"MaddahNormal", ";madd;madd;madd;madd;madd;madd;;madd;madd;madd;optionalstop|optionalnotstop;optionalnotstop;optionalnotstop;;;madd;;optionalnotstop;optionalnotstop;;madd;madd;optionalstop;optionalstop;;;;;madd;;optionalstop;optionalstop;;madd;madd;optionalnotstop;optionalnotstop;;madd;;madd;optionalstop;optionalstop;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;;madd;madd;;;;madd;;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;;;madd;optionalstop;optionalstop;madd;optionalstop;optionalstop"}, {"MaddahExchange", ";madd;madd;optionalstop;optionalnotstop;optionalnotstop;;madd;;madd;;;madd;optionalstop;optionalstop;;madd;;madd;optionalstop;optionalstop;;"}, {"MaddahEssentialConnected", ";madd;optionalstop|optionalnotstop;optionalnotstop;optionalnotstop;madd"}, {"MaddahPresentedSukun", ";madd;madd;optionalstop;optionalstop"}, {"MaddahEssentialConnectedPresentedSukun", ";madd;optionalstop;optionalstop"}, {"MaddahEssentialSeparate", "madd;optionalnotstop;optionalnotstop"}, {"MaddahObligatory", "madd"}}
        'Check = {{CachedData.GetPattern("EndOfWord"), "end"}, {"EndOfWordMadd", ";end;;end"}, {"EndOfWordUniqueLetters", ";end"}, {"EndOfWordSukun", ";end;;end;;;;;;;;end;;;;;;end;;;;;;end;;;;end;;;;end;;;;end;;;;end;;;;end;;;;;;end;;;;end;;;;end;;"}, {"EndOfWordMaddLetterPresentedSukun", ";end"}, {"EndOfWordMaddHamzaPresentedSukun", ";end"}, {"EndOfWordVowelPresentedSukun", ";end"}}
