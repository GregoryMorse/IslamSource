...
Public Class Arabic
    ...
    Public Shared PunctuationSymbols As String() = {ExclamationMark, QuotationMark, FullStop, Comma, ArabicComma}
    ...
    Public Shared WarshOrthography As RuleTranslation() = { _
      ...
      New RuleTranslation With {.Rule = "ImalaE", .Match = String.Empty, .Evaluator = ChrW(&H65C)},
      New RuleTranslation With {.Rule = "IIFinal", .Match = "(" + MakeUniRegEx(ArabicKasra) + ")" + MakeUniRegEx(ArabicLetterYeh) + "\b", .Evaluator = "$1" + ChrW(&H6D2)}
        }
    Public Shared UthmaniMinimalScript As RuleTranslation() = { _
        New RuleTranslation With {.Rule = "SmallYehSmallWawAfterPronounHeh", .Match = "((?<=" + MakeUniRegEx(ArabicLetterHeh) + MakeUniRegEx(ArabicKasra) + ")" + MakeUniRegEx(ArabicSmallYeh) + "|(?<=" + MakeUniRegEx(ArabicLetterHeh) + MakeUniRegEx(ArabicDamma) + ")" + MakeUniRegEx(ArabicSmallWaw) + ")" + MakeUniRegEx(ArabicMaddahAbove) + "?(?=$| )", _
    ...
    Public Shared SimpleEnhancedScript As RuleTranslation() = { _
        ...
        New RuleTranslation With {.Rule = "SmallSadAboveHamzaWasl", .Match = MakeUniRegEx(ArabicLetterAlefWasla), _
            .Evaluator = CStr(ArabicLetterAlef)}, _
        New RuleTranslation With {.Rule = "Alef", .Match = "(?<=(^| )" + MakeUniRegEx(ArabicLetterYeh) + MakeUniRegEx(ArabicFatha) + ")(?=" + MakeUniRegEx(ArabicLetterBeh) + MakeUniRegEx(ArabicSukun) + MakeUniRegEx(ArabicLetterNoon) + ")", _
            .Evaluator = CStr(ArabicLetterAlef) + " " + CStr(ArabicLetterAlef)}, _
        ...
        New RuleTranslation With {.Rule = "HamzaAlefEnding", .Match = "(?<=" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + MakeUniRegEx(ArabicMaddahAbove) + MakeUniRegEx(ArabicLetterHamza) + ")" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "(?= " + MakeUniRegEx(ArabicLetterAlef) + ")", _
            .Evaluator = CStr(ArabicFatha) + CStr(ArabicLetterAlefMaksura)}, _
        ...
        New RuleTranslation With {.Rule = "HamzaAlefEnding", .Match = "(?<!" + MakeUniRegEx(ArabicShadda) + MakeUniRegEx(ArabicFatha) + ")(" + MakeUniRegEx(ArabicLetterHamza) + "|" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + ")" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "(?=($| ))", _
            .Evaluator = CStr(ArabicLetterAlefWithHamzaAbove) + CStr(ArabicFatha) + CStr(ArabicLetterAlefMaksura) + CStr(ArabicLetterSuperscriptAlef)}, _
        New RuleTranslation With {.Rule = "AlefMaksura", .Match = "(?<=((?<!" + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterGhain) + "|" + MakeUniRegEx(ArabicLetterSad) + "|(?<!" + MakeUniRegEx(ArabicShadda) + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterHamza) + "|" + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterDal) + ")" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterAlef) + "(?=($| ))", _
            .Evaluator = CStr(ArabicLetterAlefMaksura)}, _
        New RuleTranslation With {.Rule = "RehAlefEnding", .Match = "(?<=" + MakeUniRegEx(ArabicLetterTeh) + MakeUniRegEx(ArabicSukun) + MakeUniRegEx(ArabicLetterReh) + "|" + MakeUniRegEx(ArabicLetterReh) + MakeUniRegEx(ArabicShadda) + "?" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterHamza) + ")" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicMaddahAbove) + "?(?=($| ))", _
            .Evaluator = CStr(ArabicFatha) + CStr(ArabicLetterAlefMaksura) + CStr(ArabicLetterSuperscriptAlef)}, _
        New RuleTranslation With {.Rule = "RehAlefEnding", .Match = "(?<=(?<!" + MakeUniRegEx(ArabicLetterHeh) + "(" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicShadda) + MakeUniRegEx(ArabicKasra) + "))" + MakeUniRegEx(ArabicLetterReh) + "(" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterHamza) + ")?)" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicMaddahAbove) + "?(?=($| ))", _
            .Evaluator = CStr(ArabicFatha) + CStr(ArabicLetterAlefMaksura)}, _
        New RuleTranslation With {.Rule = "Madda", .Match = MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicLetterSuperscriptAlef) + MakeUniRegEx(ArabicMaddahAbove) + "(?=" + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicSmallHighRoundedZero) + ")", _
            .Evaluator = String.Empty}, _
        New RuleTranslation With {.Rule = "Madda", .Match = "(" + MakeUniRegEx(ArabicLetterHamza) + "|" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + ")" + MakeUniRegEx(ArabicFatha) + "(" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")|(?<=" + MakeUniRegEx(ArabicFatha) + "|(?<!" + MakeUniRegEx(ArabicShadda) + ")" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicSukun) + "|" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + MakeUniRegEx(ArabicMaddahAbove) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + MakeUniRegEx(ArabicFatha) + "(" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicTatweel) + "?" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")", _
            .Evaluator = CStr(ArabicLetterAlefWithMaddaAbove)}, _
        New RuleTranslation With {.Rule = "Madda", .Match = MakeUniRegEx(ArabicLetterSuperscriptAlef) + MakeUniRegEx(ArabicMaddahAbove) + "(?=" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + "|" + MakeUniRegEx(ArabicLetterAlefWithMaddaAbove) + ")|(?<=(^| )(" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicFatha) + ")?" + MakeUniRegEx(ArabicLetterYeh) + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterSuperscriptAlef), _
            .Evaluator = CStr(ArabicLetterAlef) + " "},
        New RuleTranslation With {.Rule = "Madda", .Match = MakeUniRegEx(ArabicMaddahAbove), _
        ...
        New RuleTranslation With {.Rule = "Noon", .Match = "(?<=(?<! |^)" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + MakeUniRegEx(ArabicFatha) + ")(?=" + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicShadda) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterWaw) + ")", _
            .Evaluator = CStr(ArabicLetterNoon) + " "}, _
        New RuleTranslation With {.Rule = "AlefWithHamzaAbove", .Match = "(?<=" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef), _
            .Evaluator = CStr(ArabicLetterAlefWithHamzaAbove) + CStr(ArabicFathatan)}, _
        New RuleTranslation With {.Rule = "AlefWithHamzaAbove", .Match = "(?<=( |^)" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterHamza) + "(?=" + MakeUniRegEx(ArabicDamma) + ")|(?<= |^|" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterHamza) + "(?=" + MakeUniRegEx(ArabicFatha) + ")|(" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")" + MakeUniRegEx(ArabicHamzaAbove) + "|(?<=" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterWawWithHamzaAbove) + "(?!" + MakeUniRegEx(ArabicDamma) + "(?! |$))|(?<=(?<!" + MakeUniRegEx(ArabicLetterHeh) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterYeh) + ")" + MakeUniRegEx(ArabicSukun) + "|" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "(?=" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + "(?!" + MakeUniRegEx(ArabicLetterAlef) + ")|" + MakeUniRegEx(ArabicSukun) + ")", _
            .Evaluator = CStr(ArabicLetterAlefWithHamzaAbove)}, _
        New RuleTranslation With {.Rule = "WawWithHamzaAbove", .Match = "(?<=" + MakeUniRegEx(ArabicDamma) + ")(" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "|" + MakeUniRegEx(ArabicLetterHamza) + "(?=" + MakeUniRegEx(ArabicSukun) + "))", _
            .Evaluator = CStr(ArabicLetterWawWithHamzaAbove)}, _
        New RuleTranslation With {.Rule = "AlefWithHamzaBelow", .Match = "(?<=" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterHamza) + "(?=" + MakeUniRegEx(ArabicKasra) + ")", _
            .Evaluator = CStr(ArabicLetterAlefWithHamzaBelow)}, _
        New RuleTranslation With {.Rule = "YehWithHamzaAbove", .Match = "((?<!" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + "|" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicLetterWaw) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "(?=" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + "|" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicDamma) + ")|(?<=" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + "|" + MakeUniRegEx(ArabicLetterAlef) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "(?!" + MakeUniRegEx(ArabicDamma) + ")|(?<!" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterYeh) + "|" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicSukun) + ")" + MakeUniRegEx(ArabicLetterHamza) + ")(?=" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + "(?!" + MakeUniRegEx(ArabicLetterAlefMaksura) + ")|" + MakeUniRegEx(ArabicFathatan) + "|" + MakeUniRegEx(ArabicSukun) + ")(?! |$)", _
            .Evaluator = CStr(ArabicLetterYehWithHamzaAbove)}, _
        New RuleTranslation With {.Rule = "YehWithHamzaAbove", .Match = "(?<=" + MakeUniRegEx(ArabicLetterAlef) + ")" + MakeUniRegEx(ArabicLetterHamza) + MakeUniRegEx(ArabicKasra) + "(?=" + MakeUniRegEx(ArabicLetterYeh) + ")|(?<! |^|(" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterFeh) + ")" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicKasra) + ")" + MakeUniRegEx(ArabicLetterAlefWithHamzaBelow) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterYeh) + "(?! |$|" + MakeUniRegEx(ArabicLetterMeem) + ")", _
            .Evaluator = CStr(ArabicLetterYehWithHamzaAbove) + CStr(ArabicKasra)}, _
        ...
        New RuleTranslation With {.Rule = "SuperscriptAlef", .Match = "(?<=" + MakeUniRegEx(ArabicFatha) + ")(" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterAlefMaksura) + ")" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + "(?! |$)", _
            .Evaluator = CStr(ArabicLetterAlef)}, _
        New RuleTranslation With {.Rule = "SuperscriptAlef", .Match = "(?<=(?<!" + MakeUniRegEx(ArabicLetterHah) + MakeUniRegEx(ArabicSukun) + MakeUniRegEx(ArabicLetterMeem) + "|(^| )(((" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterFeh) + "|" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + ")" + MakeUniRegEx(ArabicFatha) + ")?((" + MakeUniRegEx(ArabicLetterKaf) + "|" + MakeUniRegEx(ArabicLetterWaw) + ")" + MakeUniRegEx(ArabicFatha) + "|(" + MakeUniRegEx(ArabicLetterBeh) + "|" + MakeUniRegEx(ArabicLetterLam) + ")" + MakeUniRegEx(ArabicKasra) + "))?" + MakeUniRegEx(ArabicLetterThal) + MakeUniRegEx(ArabicShadda) + "?|" + MakeUniRegEx(ArabicLetterAlefWithHamzaBelow) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterLam) + "|(^| )(" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicSukun) + ")" + MakeUniRegEx(ArabicLetterLam) + ")" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicTatweel) + "?)" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + "(?=" + MakeUniRegEx(ArabicLetterGhain) + "|" + MakeUniRegEx(ArabicLetterHeh) + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterNoon) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + ")?(?! |$|" + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterKaf) + "(" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterMeem) + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterNoon) + MakeUniRegEx(ArabicShadda) + MakeUniRegEx(ArabicFatha) + ")|" + MakeUniRegEx(ArabicLetterWawWithHamzaAbove) + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicLetterHamza) + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterThal) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterNoon) + "(" + MakeUniRegEx(ArabicShadda) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicKasra) + ")?( |$)|" + MakeUniRegEx(ArabicLetterThal) + "(" + MakeUniRegEx(ArabicFatha) + "(" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")(" + MakeUniRegEx(ArabicLetterNoon) + MakeUniRegEx(ArabicKasra) + ")?|" + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterHeh) + MakeUniRegEx(ArabicKasra) + ")|" + MakeUniRegEx(ArabicLetterHeh) + "(" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterMeem) + MakeUniRegEx(ArabicSukun) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicFatha) + "(" + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicFatha) + ")?)( | $)|" + MakeUniRegEx(ArabicLetterYehWithHamzaAbove) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterKaf) + "(" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterMeem) + MakeUniRegEx(ArabicSukun) + ")( | $))|(?<!" + MakeUniRegEx(ArabicLetterThal) + MakeUniRegEx(ArabicShadda) + "?" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + "(?=" + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicFatha) + ")|(?<=" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + "(?=" + MakeUniRegEx(ArabicLetterYeh) + MakeUniRegEx(ArabicFatha) + ")|(?<=" + MakeUniRegEx(ArabicLetterMeem) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterSeen) + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterSuperscriptAlef), _
            .Evaluator = CStr(ArabicLetterAlef)}, _
        New RuleTranslation With {.Rule = "Hamza", .Match = MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "|(?<=" + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterWaw) + ")" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + "(?=(" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicDamma) + ")( |$))|(?<=" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicLetterAlefWithMaddaAbove) + ")(" + MakeUniRegEx(ArabicLetterWawWithHamzaAbove) + "(?=(" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicDammatan) + ")($| ))|" + MakeUniRegEx(ArabicLetterYehWithHamzaAbove) + "(?=" + MakeUniRegEx(ArabicKasra) + "($| )))", _
            .Evaluator = CStr(ArabicLetterHamza)}, _
        New RuleTranslation With {.Rule = "Fathatan", .Match = "(?<=" + MakeUniRegEx(ArabicLetterJeem) + ")" + MakeUniRegEx(ArabicFatha) + "(?=" + MakeUniRegEx(ArabicLetterAlef) + "( |$))", _
            .Evaluator = CStr(ArabicFathatan)}, _
        New RuleTranslation With {.Rule = "Fatha", .Match = "(?<=(" + MakeUniRegEx(ArabicLetterNoon) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterReh) + MakeUniRegEx(ArabicKasra) + ")" + MakeUniRegEx(ArabicLetterJeem) + ")" + MakeUniRegEx(ArabicFathatan) + "(?=" + MakeUniRegEx(ArabicLetterAlef) + "( |$))", _
            .Evaluator = CStr(ArabicFatha)}
        }
    Public Shared SimpleScript As RuleTranslation() = { _
        New RuleTranslation With {.Rule = "RemoveShadda", .Match = "(?<=(^| )(" + MakeRegMultiEx(Array.ConvertAll(ArabicLetters, Function(Str As String) MakeUniRegEx(Str))) + "))" + MakeUniRegEx(ArabicShadda) + "|(?<=(" + MakeUniRegEx(ArabicLetterQaf) + "|" + MakeUniRegEx(ArabicLetterKaf) + ")" + MakeUniRegEx(ArabicLetterKaf) + "|" + MakeUniRegEx(ArabicLetterDal) + MakeUniRegEx(ArabicLetterTeh) + "|" + MakeUniRegEx(ArabicLetterYeh) + MakeUniRegEx(ArabicLetterYeh) + "|" + MakeUniRegEx(ArabicLetterHeh) + MakeUniRegEx(ArabicLetterHeh) + ")" + MakeUniRegEx(ArabicShadda) + "(?=(" + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterKaf) + "|" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterHeh) + ")?(" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + ")(((" + MakeUniRegEx(ArabicLetterNoon) + "|" + MakeUniRegEx(ArabicLetterHeh) + MakeUniRegEx(ArabicDamma) + "?)?" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + ")|" + MakeUniRegEx(ArabicLetterNoon) + MakeUniRegEx(ArabicShadda) + MakeUniRegEx(ArabicFatha) + "|(((" + MakeUniRegEx(ArabicLetterMeem) + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterWaw) + ")?" + MakeUniRegEx(ArabicLetterHeh) + "|" + MakeUniRegEx(ArabicLetterKaf) + ")(" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + "))?(" + MakeUniRegEx(ArabicLetterMeem) + "(" + MakeUniRegEx(ArabicSukun) + "|" + MakeUniRegEx(ArabicDamma) + ")?)?)( |$))", _
            .Evaluator = String.Empty}, _
        New RuleTranslation With {.Rule = "AddSukun", .Match = "(?<!( |^)(" + MakeRegMultiEx(Array.ConvertAll(ArabicUniqueLetters,
                Function(Str As String)
                    Dim FixStr As String = String.Empty
                    Str = TransliterateFromBuckwalter(Str).Replace(CStr(ArabicMaddahAbove), String.Empty)
                    For Count As Integer = 0 To Str.Length - 1
                        If Str(Count) <> ArabicLetterAlef Then
                            FixStr += MakeUniRegEx(Str.Substring(0, Count + 1)) + If(Count <> Str.Length - 1, "(?=" + MakeUniRegEx(Str.Substring(Count + 1)) + ")|", String.Empty)
                        End If
                    Next
                    Return FixStr
                End Function)) + "))(?<=" + MakeRegMultiEx(Array.ConvertAll(ArabicSunLetters, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicMoonLettersNoVowels, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeUniRegEx(ArabicFatha) + "(" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterYeh) + "))(?= |$|(" + MakeRegMultiEx(Array.ConvertAll(ArabicSunLetters, Function(Str As String) MakeUniRegEx(Str))) + ")(?!" + MakeUniRegEx(ArabicShadda) + ")|" + MakeRegMultiEx(Array.ConvertAll(ArabicMoonLetters, Function(Str As String) MakeUniRegEx(Str))) + ")", _
            .Evaluator = CStr(ArabicSukun)}
    }
    ...
    Public Shared SimpleMinAlefLams As String = "(?<=(^| )(" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterFeh) + "|" + MakeUniRegEx(ArabicLetterKaf) + "))" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "(?=" + MakeUniRegEx(ArabicLetterLam) + ").*?(?= |$)"
    Public Shared SimpleMinAlefNotLams As String = "(?<=(^| )(" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterFeh) + "))" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "(?!" + MakeUniRegEx(ArabicLetterLam) + ").*?(?= |$)"
    Public Shared SimpleMinimalScript As RuleTranslation() = { _
        ...
        New RuleTranslation With {.Rule = "RemoveSukun", .Match = MakeUniRegEx(ArabicSukun), _
            .Evaluator = String.Empty}, _
        New RuleTranslation With {.Rule = "RemoveLongVowelDiacritics", .Match = "((?<!(^| )((" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicFatha) + ")?" + MakeUniRegEx(ArabicLetterTeh) + "|" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterFeh) + "|" + MakeUniRegEx(ArabicLetterKaf) + "))" + MakeUniRegEx(ArabicFatha) + "(?=" + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicLetterLam) + ")|(?<=(^| )(" + MakeUniRegEx(ArabicLetterWaw) + "|(" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + MakeUniRegEx(ArabicFatha) + ")?" + MakeUniRegEx(ArabicLetterFeh) + "))" + MakeUniRegEx(ArabicFatha) + "(?=" + MakeUniRegEx(ArabicLetterAlef) + "(?!" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "?|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicLetterAlef) + "?" + "( " + MakeUniRegEx(ArabicSmallHighJeem) + "| " + MakeUniRegEx(ArabicSmallHighLamAlef) + ")?" + " " + MakeUniRegEx(ArabicLetterAlef) + ")((" + MakeUniRegEx(ArabicLetterTeh) + "|" + MakeUniRegEx(ArabicLetterTheh) + "|" + MakeUniRegEx(ArabicLetterDad) + "|" + MakeUniRegEx(ArabicLetterQaf) + ")" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterHamza) + "|(" + MakeUniRegEx(ArabicLetterJeem) + "|" + MakeUniRegEx(ArabicLetterBeh) + "|" + MakeUniRegEx(ArabicLetterReh) + "|" + MakeUniRegEx(ArabicLetterSeen) + "|" + MakeUniRegEx(ArabicLetterSad) + "|" + MakeUniRegEx(ArabicLetterTah) + "|" + MakeUniRegEx(ArabicLetterHah) + ")" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterHeh) + "|" + MakeUniRegEx(ArabicLetterHeh) + "(" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicDamma) + ")|(" + MakeUniRegEx(ArabicLetterDal) + "|" + MakeUniRegEx(ArabicLetterQaf) + "|" + MakeUniRegEx(ArabicLetterLam) + ")(" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicKasratan) + ")|(" + MakeUniRegEx(ArabicLetterZain) + "|" + MakeUniRegEx(ArabicLetterAin) + ")(" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicFatha) + ")|" + MakeUniRegEx(ArabicLetterNoon) + MakeUniRegEx(ArabicKasratan) + "))|(?<!(^| )(" + MakeUniRegEx(ArabicLetterWaw) + "|(" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + MakeUniRegEx(ArabicFatha) + ")?" + MakeUniRegEx(ArabicLetterFeh) + "|" + MakeUniRegEx(ArabicLetterLam) + ")|" + MakeUniRegEx(ArabicLetterYehWithHamzaAbove) + ")" + MakeUniRegEx(ArabicFatha) + "(?=" + MakeUniRegEx(ArabicLetterAlef) + "(?!" + MakeUniRegEx(ArabicLetterLam) + "(?!" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicKasratan) + "))(?!" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "?|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicLetterAlef) + "?" + "( " + MakeUniRegEx(ArabicSmallHighJeem) + "| " + MakeUniRegEx(ArabicSmallHighLamAlef) + ")?" + " " + MakeUniRegEx(ArabicLetterAlef) + "))|(?<=^" + MakeUniRegEx(ArabicLetterLam) + ")" + MakeUniRegEx(ArabicFatha) + "(?=" + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicLetterBeh) + ")(?!" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "?|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicLetterAlef) + "?" + "( " + MakeUniRegEx(ArabicSmallHighJeem) + "| " + MakeUniRegEx(ArabicSmallHighLamAlef) + ")?" + " " + MakeUniRegEx(ArabicLetterAlef) + ")|(?<=(^| )" + MakeUniRegEx(ArabicLetterLam) + ")" + MakeUniRegEx(ArabicFatha) + "(?=" + MakeUniRegEx(ArabicLetterAlef) + "(?! " + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicLetterNoon) + "|" + MakeUniRegEx(ArabicLetterFeh) + "|" + MakeUniRegEx(ArabicLetterReh) + "|" + MakeUniRegEx(ArabicLetterTeh) + "|" + MakeUniRegEx(ArabicLetterBeh) + "|" + MakeUniRegEx(ArabicLetterKhah) + "|" + MakeUniRegEx(ArabicLetterSeen) + "|" + MakeUniRegEx(ArabicLetterSad) + "))|" + MakeUniRegEx(ArabicFatha) + "(?=" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + "|" + MakeUniRegEx(ArabicLetterAlefMaksura) + "(?!($| " + MakeUniRegEx(ArabicSmallHighLamAlef) + "| " + MakeUniRegEx(ArabicSmallHighLigatureSadWithLamWithAlefMaksura) + "))(?!" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "?|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicLetterAlef) + "?" + "( " + MakeUniRegEx(ArabicSmallHighJeem) + "| " + MakeUniRegEx(ArabicSmallHighLamAlef) + ")?" + " " + MakeUniRegEx(ArabicLetterAlef) + "))|(?<!" + MakeUniRegEx(ArabicLetterJeem) + ")" + MakeUniRegEx(ArabicKasra) + "(?=" + MakeUniRegEx(ArabicLetterYeh) + MakeUniRegEx(ArabicLetterHamza) + ")(?!" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "?|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicLetterAlef) + "?" + "( " + MakeUniRegEx(ArabicSmallHighJeem) + "| " + MakeUniRegEx(ArabicSmallHighLamAlef) + ")?" + " " + MakeUniRegEx(ArabicLetterAlef) + ")|(?<=" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterKhah) + "|" + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterNoon) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterFeh) + MakeUniRegEx(ArabicLetterSeen) + "| " + MakeUniRegEx(ArabicLetterThal) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicLetterReh) + ")" + MakeUniRegEx(ArabicKasra) + "(?=" + MakeUniRegEx(ArabicLetterYeh) + "(?!$)(?!" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "?|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicLetterAlef) + "?" + "( " + MakeUniRegEx(ArabicSmallHighJeem) + "| " + MakeUniRegEx(ArabicSmallHighLamAlef) + ")?" + " " + MakeUniRegEx(ArabicLetterAlef) + "))|(?<!" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterKhah) + "|" + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterNoon) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterFeh) + MakeUniRegEx(ArabicLetterSeen) + "| " + MakeUniRegEx(ArabicLetterThal) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicLetterReh) + ")" + MakeUniRegEx(ArabicKasra) + "(?=" + MakeUniRegEx(ArabicLetterYeh) + "(?!" + MakeUniRegEx(ArabicLetterHamza) + ")(?!" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "?|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicLetterAlef) + "?" + "( " + MakeUniRegEx(ArabicSmallHighJeem) + "| " + MakeUniRegEx(ArabicSmallHighLamAlef) + ")?" + " " + MakeUniRegEx(ArabicLetterAlef) + "))|(?<=(^| )(" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicFatha) + ")?" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + ")" + MakeUniRegEx(ArabicDamma) + "(?=" + MakeUniRegEx(ArabicLetterWaw) + "(?!" + MakeUniRegEx(ArabicLetterLam) + "(" + MakeUniRegEx(ArabicFatha) + "(" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + "|" + MakeUniRegEx(ArabicLetterAlef) + "(" + MakeUniRegEx(ArabicLetterTeh) + "|" + MakeUniRegEx(ArabicLetterHamza) + "))|" + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterYeh) + "|" + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterWaw) + "))(?!" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "?|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicLetterAlef) + "?" + "( " + MakeUniRegEx(ArabicSmallHighJeem) + "| " + MakeUniRegEx(ArabicSmallHighLamAlef) + ")?" + " " + MakeUniRegEx(ArabicLetterAlef) + "))|(?<!(^| )(" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicFatha) + ")?" + MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + ")" + MakeUniRegEx(ArabicDamma) + "(?=" + MakeUniRegEx(ArabicLetterWaw) + "(?!" + MakeUniRegEx(ArabicLetterLam) + "(" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterSuperscriptAlef) + MakeUniRegEx(ArabicLetterYehWithHamzaAbove) + "|" + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterYeh) + " " + MakeUniRegEx(ArabicLetterAlef) + "))(?!" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + MakeUniRegEx(ArabicLetterAlef) + "?|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicShadda) + "|" + MakeUniRegEx(ArabicLetterAlef) + "?" + "( " + MakeUniRegEx(ArabicSmallHighJeem) + "| " + MakeUniRegEx(ArabicSmallHighLamAlef) + ")?" + " " + MakeUniRegEx(ArabicLetterAlef) + ")))", _
            .Evaluator = String.Empty}
    }
    ...
    Public Shared ErrorCheckRules As RuleTranslation() = { _
            ...
            New RuleTranslation With {.Rule = "OnlyAtEndOfWord", .Match = MakeUniRegEx(ArabicLetterAlefMaksura) + "(" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicTanweens, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")?\B|" + MakeUniRegEx(ArabicLetterTehMarbuta) + "(" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicTanweens, Function(Str As String) MakeUniRegEx(Str))) + ")?\B", _
                                      .Evaluator = "$&"}, _
            New RuleTranslation With {.Rule = "NotAtStartOfWord", .Match = "\b[" + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicShadda) + MakeUniRegEx(ArabicSukun) + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + MakeRegMultiEx(Array.ConvertAll(ArabicTanweens, Function(Str As String) MakeUniRegEx(Str))) + "]", _
                                      .Evaluator = "$&"}, _
            New RuleTranslation With {.Rule = "OnlyAtStartOfWord", .Match = "\B" + MakeUniRegEx(ArabicLetterAlefWasla), _
                                      .Evaluator = "$&"}, _
            New RuleTranslation With {.Rule = "NotValidCombination", .Match = MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterYeh) + "|" + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterWaw), _
                                      .Evaluator = "$&"}, _
    ...
    Public Shared BreakdownRules As RuleTranslation() = { _
            New RuleTranslation With {.Rule = "AlefMaddah", .Match = MakeUniRegEx(ArabicLetterAlefWithMaddaAbove), _
                                      .Evaluator = ArabicLetterAlef + ArabicMaddahAbove}, _
            New RuleTranslation With {.Rule = "Maddah", .Match = MakeUniRegEx(ArabicMaddahAbove), _
                .Evaluator = ArabicLetterHamza + ArabicFatha + ArabicLetterAlef}, _
            New RuleTranslation With {.Rule = "AlefHamzah", .Match = MakeUniRegEx(ArabicLetterAlefWithHamzaAbove) + "|" + MakeUniRegEx(ArabicLetterAlefWithHamzaBelow), _
                                      .Evaluator = ArabicLetterAlef + ArabicLetterHamza}, _
            New RuleTranslation With {.Rule = "WawHamzah", .Match = MakeUniRegEx(ArabicLetterWawWithHamzaAbove), _
                                      .Evaluator = ArabicLetterWaw + ArabicLetterHamza}, _
            New RuleTranslation With {.Rule = "YehHamzah", .Match = MakeUniRegEx(ArabicLetterYehWithHamzaAbove), _
                                      .Evaluator = ArabicLetterAlefMaksura + ArabicLetterHamza}, _
            New RuleTranslation With {.Rule = "SmallWaw", .Match = MakeUniRegEx(ArabicSmallWaw), _
                                      .Evaluator = ArabicLetterWaw}, _
            New RuleTranslation With {.Rule = "SmallYeh", .Match = MakeUniRegEx(ArabicSmallYeh), _
                                      .Evaluator = ArabicLetterYeh}, _
            New RuleTranslation With {.Rule = "SmallMeem", .Match = MakeUniRegEx(ArabicSmallLowMeem) + "|" + MakeUniRegEx(ArabicSmallHighMeemIsolatedForm), _
                                      .Evaluator = ArabicLetterAlef + ArabicLetterHamza}, _
            New RuleTranslation With {.Rule = "SmallNoon", .Match = MakeUniRegEx(ArabicSmallHighNoon), _
                                      .Evaluator = ArabicLetterNoon}, _
            New RuleTranslation With {.Rule = "SmallSeen", .Match = MakeUniRegEx(ArabicSmallHighSeen), _
                                      .Evaluator = ArabicLetterSeen}, _
            New RuleTranslation With {.Rule = "DaggerAlef", .Match = MakeUniRegEx(ArabicLetterSuperscriptAlef), _
                                      .Evaluator = ArabicLetterAlef}, _
            New RuleTranslation With {.Rule = "SmallHamza", .Match = MakeUniRegEx(ArabicHamzaAbove) + "|" + MakeUniRegEx(ArabicHamzaBelow), _
                                      .Evaluator = ArabicLetterHamza}, _
            New RuleTranslation With {.Rule = "LetterSpelling", .Match = "\b(" + MakeRegMultiEx(Array.ConvertAll(ArabicUniqueLetters, Function(Str As String) MakeUniRegEx(TransliterateFromBuckwalter(Str)))) + ")\b", _
                                      .Evaluator = "$&", .RuleFunc = RuleFuncs.eSpellLetter}, _
            New RuleTranslation With {.Rule = "NumberSpelling", .Match = "\b(" + MakeRegMultiEx(Array.ConvertAll(ArabicNumbers, Function(Str As String) MakeUniRegEx(TransliterateFromBuckwalter(Str)))) + ")+\b", _
                                      .Evaluator = "$&", .RuleFunc = RuleFuncs.eSpellNumber}, _
            New RuleTranslation With {.Rule = "FathaAlefMaksura", .Match = "(" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterAlefMaksura), _
                                      .Evaluator = "$1" + ArabicLetterAlef}, _
            New RuleTranslation With {.Rule = "KasraAlefMaksura", .Match = "(" + MakeUniRegEx(ArabicKasra) + ")" + MakeUniRegEx(ArabicLetterAlefMaksura), _
                                      .Evaluator = "$1" + ArabicLetterYeh}, _
            New RuleTranslation With {.Rule = "TehMarbuta", .Match = MakeUniRegEx(ArabicLetterTehMarbuta) + "(?=" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicTanweens, Function(Str As String) MakeUniRegEx(Str))) + ")", _
                                      .Evaluator = ArabicLetterTeh}, _
            New RuleTranslation With {.Rule = "TehMarbuta", .Match = MakeUniRegEx(ArabicLetterTehMarbuta), _
    ...
    Public Shared RuleFunctions As RuleFunction() = {
        ...
        Function(Str As String) GutteralRules(Str, 0, False, True),
        Function(Str As String) GutteralRules(Str, 0, True, False)
        } '.toUpperCase()
    ...
    Public Shared RomanizationRules As RuleTranslation() = { _
            New RuleTranslation With {.Rule = "GutteralRulesBoth", .Match = "(" + MakeRegMultiEx(Array.ConvertAll(ArabicLongVowels, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + ")(" + MakeRegMultiEx(Array.ConvertAll(ArabicSpecialLeadingGutteral, Function(Str As String) MakeUniRegEx(Str))) + ")(" + MakeRegMultiEx(Array.ConvertAll(ArabicLongVowels, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicTanweens, Function(Str As String) MakeUniRegEx(Str))) + ")", _
                                      .Evaluator = "$&", .RuleFunc = RuleFuncs.eGutteralRulesBoth}, _
            New RuleTranslation With {.Rule = "GutteralRules", .Match = "(" + MakeRegMultiEx(Array.ConvertAll(ArabicSpecialGutteral, Function(Str As String) MakeUniRegEx(Str))) + ")(" + MakeRegMultiEx(Array.ConvertAll(ArabicLongVowels, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicTanweens, Function(Str As String) MakeUniRegEx(Str))) + ")", _
                                      .Evaluator = "$&", .RuleFunc = RuleFuncs.eGutteralRules}, _
            New RuleTranslation With {.Rule = "LeadingGutteralRules", .Match = "(" + MakeRegMultiEx(Array.ConvertAll(ArabicLongVowels, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + ")(" + MakeUniRegEx(ArabicLetterHamza) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicSpecialLeadingGutteral, Function(Str As String) MakeUniRegEx(Str))) + ")", _
                                      .Evaluator = "$&", .RuleFunc = RuleFuncs.eLeadingGutteralRules}, _
    ...
    Public Shared ColoringSpelledOutRules As RuleTranslation() = { _
            ...
            New RuleTranslation With {.Rule = "Empty", .Match = "empty", _
                                      .Evaluator = String.Empty}, _
            New RuleTranslation With {.Rule = "Normal", .Match = "helpermeem|assimilator|assimilatorincomplete|dipthong|compulsorystop|endofversestop|prostration|canstoporcontinue|betternottostop|stopatfirstnotsecond|stopatsecondnotfirst|bettertostopbutpermissibletocontinue|bettertocontinuebutpermissibletostop|subtlestopwithoutbreath", .Evaluator = "{0}"}, _
    ...
    Public Shared RulesOfRecitationRegEx As RuleMetadataTranslation() = { _
            New RuleMetadataTranslation With {.Rule = "Stopping", .Match = "(" + MakeUniRegEx(ArabicSmallHighMeemIsolatedForm) + ")|(" + MakeUniRegEx(ArabicStartOfRubElHizb) + ")|(" + MakeUniRegEx(ArabicEndOfAyah) + ")|(" + MakeUniRegEx(ArabicPlaceOfSajdah) + ")(?=\s*\b)",
                .Evaluator = New String() {"compulsorystop", "startofhizbstop", "endofversestop", "prostration"}}, _
            New RuleMetadataTranslation With {.Rule = "Stopping", .Match = "(" + MakeUniRegEx(ArabicSmallHighJeem) + ")|(" + MakeUniRegEx(ArabicSmallHighLamAlef) + ")|(" + MakeUniRegEx(ArabicSmallHighThreeDots) + ")(\w*)(" + MakeUniRegEx(ArabicSmallHighThreeDots) + ")|(" + MakeUniRegEx(ArabicSmallHighLigatureQafWithLamWithAlefMaksura) + ")|(" + MakeUniRegEx(ArabicSmallHighLigatureSadWithLamWithAlefMaksura) + ")|(" + MakeUniRegEx(ArabicSmallHighSeen) + ")",
            ...
            New RuleMetadataTranslation With {.Rule = "Stopping", .Match = "(" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeUniRegEx(ArabicKasratan) + "|" + MakeUniRegEx(ArabicDammatan) + ")(?=\s*$)",
                .Evaluator = New String() {"empty"}}, _
            New RuleMetadataTranslation With {.Rule = "Stopping", .Match = "(" + MakeUniRegEx(ArabicLetterTehMarbuta) + ")(?=" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + "|" + MakeRegMultiEx(Array.ConvertAll(ArabicTanweens, Function(Str As String) MakeUniRegEx(Str))) + ")",
            ...
            New RuleMetadataTranslation With {.Rule = "CharacterDoubled", .Match = "(" + MakeUniRegEx(ArabicLetterMeem) + MakeUniRegEx(ArabicShadda) + ")",
                .Evaluator = New String() {"nasalize|normalprolong"}}, _
            New RuleMetadataTranslation With {.Rule = "VowellessMeemHide", .Match = "(?:(" + MakeUniRegEx(ArabicLetterMeem) + MakeUniRegEx(ArabicSukun) + ")|(" + MakeUniRegEx(ArabicLetterMeem) + ")(?:\b\s*))(" + MakeUniRegEx(ArabicLetterBeh) + "(?=" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicKasra) + "))",
                .Evaluator = New String() {"assimilate", "assimilate", "nasalize|normalprolong|assimilator"}}, _
            New RuleMetadataTranslation With {.Rule = "VowellessMeemAssimilating", .Match = "(?:(" + MakeUniRegEx(ArabicLetterMeem) + MakeUniRegEx(ArabicSukun) + ")|(" + MakeUniRegEx(ArabicLetterMeem) + ")(?:\b\s*))(" + MakeUniRegEx(ArabicLetterMeem) + "(?=" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicKasra) + "))",
                .Evaluator = New String() {"assimilate", "assimilate", "nasalize|normalprolong|assimilator"}}, _
            ...
            New RuleMetadataTranslation With {.Rule = "EmptyHamza", .Match = "(^\s*)(" + MakeUniRegEx(ArabicLetterAlefWasla) + ")(?=(" + MakeRegMultiEx(Array.ConvertAll(ArabicLetters, Function(Str As String) MakeUniRegEx(Str))) + ")(" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + ")?" + "(" + MakeRegMultiEx(Array.ConvertAll(ArabicLetters, Function(Str As String) MakeUniRegEx(Str))) + ")(" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicKasra) + ")|" + MakeRegMultiEx(Array.ConvertAll(ArabicWaslKasraExceptions, Function(Str As String) MakeUniRegEx(TransliterateFromBuckwalter(Str)))) + ")",
                .Evaluator = New String() {Nothing, "helperkasra"}}, _
            New RuleMetadataTranslation With {.Rule = "EmptyHamza", .Match = "(^\s*)(" + MakeUniRegEx(ArabicLetterAlefWasla) + ")(?=(" + MakeRegMultiEx(Array.ConvertAll(ArabicLetters, Function(Str As String) MakeUniRegEx(Str))) + ")(" + MakeRegMultiEx(Array.ConvertAll(ArabicFathaDammaKasra, Function(Str As String) MakeUniRegEx(Str))) + ")?" + "(" + MakeRegMultiEx(Array.ConvertAll(ArabicLetters, Function(Str As String) MakeUniRegEx(Str))) + ")" + MakeUniRegEx(ArabicDamma) + ")",
                .Evaluator = New String() {Nothing, "helperdamma"}}, _
            New RuleMetadataTranslation With {.Rule = "EmptyHamza", .Match = "(\w+\s*)(" + MakeUniRegEx(ArabicLetterAlefWasla) + ")",
                .Evaluator = New String() {Nothing, "empty"}}, _
            New RuleMetadataTranslation With {.Rule = "AssimilateLaamSunLetter", .Match = "((?:^\s*|\b)(?:" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterBeh) + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicLetterTeh) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicKasra) + ")?)(" + MakeUniRegEx(ArabicLetterAlefWasla) + MakeUniRegEx(ArabicLetterLam) + ")(" + MakeRegMultiEx(Array.ConvertAll(ArabicSunLetters, Function(Str As String) MakeUniRegEx(Str))) + ")(?=" + MakeUniRegEx(ArabicShadda) + ")",
                .Evaluator = New String() {Nothing, "assimilate", "assimilator"}}, _
            New RuleMetadataTranslation With {.Rule = "ClearLaamMoonLetter", .Match = "((?:^\s*|\b)(?:" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterBeh) + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicLetterTeh) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterKaf) + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicKasra) + ")?)(" + MakeUniRegEx(ArabicLetterAlefWasla) + ")(" + MakeUniRegEx(ArabicLetterLam) + ")(?=" + MakeUniRegEx(ArabicSukun) + "?(?:" + MakeRegMultiEx(Array.ConvertAll(ArabicMoonLetters, Function(Str As String) MakeUniRegEx(Str))) + "))",
                .Evaluator = New String() {Nothing, "assimilate", "assimilator"}}, _
    ...
    Public Shared Function ArabicWordForLessThanThousand(ByVal Number As Integer, UseClassic As Boolean, UseAlefHundred As Boolean) As String
        ...
        If Number >= 100 Then
            ...
            If Number = 100 Then Return HundStr
    ...
    Public Shared Function ChangeScript(ArabicString As String, ScriptType As TanzilReader.QuranScripts) As String
        ...
        ElseIf ScriptType = TanzilReader.QuranScripts.SimpleClean Then
            ...
            For Count = 0 To SimpleCleanScript.Length - 1
                ArabicString = System.Text.RegularExpressions.Regex.Replace(ArabicString, SimpleCleanScript(Count).Match, SimpleCleanScript(Count).Evaluator)
            Next
        ElseIf ScriptType = TanzilReader.QuranScripts.SimpleMin Then
            ...
            For Count = 0 To SimpleMinimalScript.Length - 1
                ArabicString = System.Text.RegularExpressions.Regex.Replace(ArabicString, SimpleMinimalScript(Count).Match, SimpleMinimalScript(Count).Evaluator)
            Next
        End If
        Return ArabicString
    End Function
    ...
    Public Shared Function GetTransliterateNumberJS() As String()
        Dim GetJS As New List(Of String) From {"javascript: doTransliterateNum();", String.Empty, GetArabicSymbolJSArray(), TransliterateGenJS}
        GetJS.AddRange(NumberGenJS)
        Return GetJS.ToArray()
    End Function
    Public Shared Function GetTransliterateJS() As String()
        Dim GetJS As New List(Of String) From {"javascript: doTransliterateDisplay();", String.Empty, GetArabicSymbolJSArray(), TransliterateGenJS, _
    ...
    Public Shared Function GetChangeTransliterationJS() As String()
        Dim GetJS As New List(Of String) From {"javascript: changeTransliteration();", String.Empty, Utility.GetLookupStyleSheetJS(), GetArabicSymbolJSArray(), TransliterateGenJS, _
