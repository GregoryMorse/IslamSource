...
Public Class TanzilReader
    ...
    Public Shared Sub CheckMutualExclusiveRules(bAssumeStop As Boolean)
        ...
        Check = {{CachedData.GetPattern("PossibleMadd"), "madd"}, {"MaddahCatcher", "madd;;madd;optionalnotstop;optionalnotstop;;madd;optionalstop;optionalstop;;madd;optionalnotstop;optionalnotstop"}, {"MaddahNormal", ";madd;madd;madd;madd;madd;madd;madd;madd;optionalstop;optionalnotstop;optionalnotstop;;;madd;;optionalnotstop;optionalnotstop;;madd;madd;optionalstop;optionalstop;;;;;madd;;optionalstop;optionalstop;;madd;madd;optionalnotstop;optionalnotstop;;madd;madd;;;;madd;madd;madd;;;;madd;;;madd;;;;madd;optionalstop;optionalstop;madd;optionalstop;optionalstop"}, {"MaddahExchange", ";madd;madd;optionalstop;optionalnotstop;optionalnotstop;;madd;;madd;;;;madd;;madd;optionalstop;optionalstop;;"}, {"MaddahEssentialConnected", ";madd;optionalstop;optionalnotstop;optionalnotstop;madd"}, {"MaddahPresentedSukun", ";madd;madd;optionalstop;optionalstop"}, {"MaddahEssentialConnectedPresentedSukun", ";madd;optionalstop;optionalstop"}, {"MaddahEssentialSeparate", "madd;optionalnotstop;optionalnotstop"}, {"MaddahObligatory", "madd"}}
