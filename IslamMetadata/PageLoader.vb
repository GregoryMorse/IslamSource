...
Public Class TanzilReader
    ...
    Public Shared Sub CheckMutualExclusiveRules(bAssumeContinue As Boolean)
        ...
        'Check = {{CachedData.GetPattern("PossibleMadd"), "madd"}, {"MaddahCatcher", "madd;;madd;optionalnotstop;optionalnotstop;;madd;optionalstop;optionalstop;;madd;optionalnotstop;optionalnotstop;;;madd;madd;optionalnotstop;optionalnotstop;madd;optionalnotstop;optionalnotstop;optionalnotstop;optionalnotstop;;madd;optionalnotstop;optionalnotstop;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd;madd"}, {"MaddahNormal", ";madd;madd;madd;madd;madd;madd;;madd;madd;madd;optionalstop|optionalnotstop;optionalnotstop;optionalnotstop;;;madd;;optionalnotstop;optionalnotstop;;madd;madd;optionalstop;optionalstop;;;;;madd;;optionalstop;optionalstop;;madd;madd;optionalnotstop;optionalnotstop;;madd;;madd;optionalstop;optionalstop;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;;madd;;;madd;;;madd;madd;;;;madd;;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;madd;;;;madd;optionalstop;optionalstop;madd;optionalstop;optionalstop"}, {"MaddahExchange", ";madd;madd;optionalstop;optionalnotstop;optionalnotstop;;madd;;madd;;;madd;optionalstop;optionalstop;;madd;;madd;optionalstop;optionalstop;;"}, {"MaddahEssentialConnected", ";madd;optionalstop|optionalnotstop;optionalnotstop;optionalnotstop;madd"}, {"MaddahPresentedSukun", ";madd;madd;optionalstop;optionalstop"}, {"MaddahEssentialConnectedPresentedSukun", ";madd;optionalstop;optionalstop"}, {"MaddahEssentialSeparate", "madd;optionalnotstop;optionalnotstop"}, {"MaddahObligatory", "madd"}}
        'Check = {{CachedData.GetPattern("LeenMadd"), "madd"}, {"MaddahLeenCatcher", "madd;;madd"}, {"MaddahLeen", ";madd;madd;madd;optionalnotstop;optionalnotstop;madd;madd;;madd;optionalstop;optionalstop;madd;optionalstop;optionalstop;madd;;;;"}, {"MaddahLeenPresentedSukun", ";madd;madd;madd;optionalstop;optionalstop"}}
        ...
        'Check = {{CachedData.GetPattern("Yehs"), "yeh"}, {"NotYeh", "yeh;;yeh;;yeh;;yeh;;;;yeh;optionalnotstop;optionalnotstop;yeh;optionalstop;optionalstop"}, {"MaddYeh", ";yeh;optionalstop;optionalstop;optionalstop;optionalstop;yeh;optionalnotstop;optionalnotstop;optionalstop;optionalstop"}, {"LeenYeh", ";yeh;;yeh;optionalstop;optionalstop"}, {"StrongYeh", ";yeh;;yeh;;yeh;;yeh;yeh;;yeh;;yeh;;yeh;;yeh;optionalnotstop;optionalnotstop;;yeh;;yeh;;yeh;optionalnotstop;optionalnotstop"}}
        'Check = {{CachedData.GetPattern("Waws"), "waw"}, {"NotWaw", "waw;;waw;;waw;optionalnotstop;optionalnotstop;;optionalstop;optionalstop;waw;;waw;optionalnotstop;optionalnotstop;optionalstop;optionalstop"}, {"MaddWaw", ";waw;optionalstop;optionalstop;optionalstop;optionalstop;optionalnotstop;optionalnotstop"}, {"LeenWaw", ";waw;optionalstop;optionalstop;optionalstop;optionalstop;;optionalnotstop;optionalnotstop;waw"}, {"StrongWaw", ";optionalnotstop;optionalnotstop;waw;;waw;;waw;;optionalstop;optionalstop;waw;;waw;optionalnotstop;optionalnotstop;;waw;optionalnotstop;optionalnotstop"}}
        Dim IndexToVerse As Integer()() = Nothing
