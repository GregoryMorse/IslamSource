...
Public Class TanzilReader
    ...
    Public Shared Sub CheckMutualExclusiveRules(bAssumeContinue As Boolean)
        ...
        Check = {{CachedData.GetPattern("Waws"), "waw"}, {"NotWaw", "waw;;waw;;waw;optionalnotstop;;optionalstop;;waw;;waw;optionalnotstop;optionalstop"}, {"MaddWaw", ";waw;optionalstop;optionalstop;optionalstop;optionalstop;optionalnotstop;optionalnotstop"}, {"LeenWaw", ";waw;optionalstop;optionalstop;optionalstop;optionalstop;;optionalnotstop;optionalnotstop;waw"}, {"StrongWaw", ";optionalnotstop;optionalnotstop;waw;;waw;;waw;;optionalstop;optionalstop;waw;;waw;optionalnotstop;optionalnotstop;;waw;optionalnotstop;optionalnotstop"}}
        Dim IndexToVerse As Integer()() = Nothing
