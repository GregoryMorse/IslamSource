...
Public Class TanzilReader
    ...
    Public Shared Sub CheckSequentialRules()
        Dim Check As String()() = {
            ...
            New String() {ArabicData.ArabicLetterAlefWithHamzaAbove, "(?:{StartOfWord})(?:(?:{Hamzas}){ArabicFatha}(?:(?:{ArabicLetterFeh}|{ArabicLetterWaw}){ArabicFatha})?|{ArabicLetterHeh}{ArabicFatha}{ArabicLetterSuperscriptAlef}{ArabicMaddahAbove})", "{ArabicFatha}(?:{ArabicSunLetters}|{ArabicMoonLettersNoVowels})"},
 ...
 _
            ...
            New String() {ArabicData.ArabicLetterWawWithHamzaAbove, "{ArabicFatha}(?:{ArabicLetterSuperscriptAlef}{ArabicMaddahAbove})?", "(?:{ArabicDamma}|{ArabicDammatan}){ArabicLetterAlef}"},
 ...
 _
            ...
            New String() {ArabicData.ArabicLetterHamza, "(?:{ArabicNonConnectingLetters}|{ArabicLetterWaw})(?:{ArabicSukun}|{ArabicShadda}?(?:{ArabicFatha}|{ArabicDamma}|{ArabicKasra}))|{ArabicFatha}{ArabicLetterAlef}{ArabicMaddahAbove}", "{ArabicDamma}{ArabicLetterWaw}"},
 _
 ...
 _
            New String() {ArabicData.ArabicLetterHamza, "{ArabicFatha}{ArabicLetterAlef}{ArabicMaddahAbove}|{ArabicKasra}(?:{ArabicLetterAlef}{ArabicSmallHighRoundedZero})?{ArabicLetterAlefMaksura}{ArabicMaddahAbove}|{ArabicDamma}{ArabicLetterWaw}{ArabicMaddahAbove}|{ArabicSukun}", "(?:{ArabicFatha}|{ArabicDamma}|{ArabicKasra}|{ArabicFathatan}|{ArabicKasratan}|{ArabicDammatan})(?:{EndOfWord})"},
 _
            New String() {ArabicData.ArabicLetterAlefWithHamzaAbove, "{ArabicFatha}", "{ArabicSukun}|{ArabicFatha}|{ArabicDamma}|{ArabicDammatan}"},
            New String() {ArabicData.ArabicLetterAlefWithHamzaAbove, "{ArabicFatha}", "{ArabicKasra}|{ArabicKasratan}"},
            New String() {ArabicData.ArabicLetterYehWithHamzaAbove, "{ArabicKasra}", "{ArabicSukun}|{ArabicFatha}|{ArabicDamma}|{ArabicKasra}|{ArabicKasratan}"},
            New String() {ArabicData.ArabicLetterWawWithHamzaAbove, "{ArabicDamma}", "{ArabicSukun}|{ArabicDamma}|{ArabicKasra}|{ArabicDammatan}"}
        } 'New String() {ArabicData.ArabicTatweel + ArabicData.ArabicHamzaAbove, "", ""},
    ...
    Public Shared Sub CheckMutualExclusiveRules(bAssumeStop As Boolean)
        ...
        'Check = {{CachedData.GetPattern("PossibleMadd"), "madd"}, {"MaddahCatcher", "madd;;madd;optionalnotstop;optionalnotstop;;madd;optionalstop;optionalstop;;madd;optionalnotstop;optionalnotstop"}, {"MaddahNormal", ";;madd;;optionalnotstop;optionalnotstop;;madd;madd;optionalstop;optionalstop;;;;;madd;;optionalstop;optionalstop;;madd;madd;optionalnotstop;optionalnotstop;;madd;madd;;;;madd;madd;madd;;;;madd;;;madd;;;;madd;optionalstop;optionalstop;madd;optionalstop;optionalstop"}, {"MaddahExchange", ";madd;;madd;;;;madd;;madd;optionalstop;optionalstop;;"}, {"MaddahEssentialConnected", "madd"}, {"MaddahEssentialSeparate", "madd;optionalnotstop;optionalnotstop"}, {"MaddahObligatory", "madd"}}
