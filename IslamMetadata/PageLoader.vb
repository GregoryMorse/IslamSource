...
Public Class Arabic
    ...
    Public Shared SimpleEnhancedScript As RuleTranslation() = { _
        ...
        New RuleTranslation With {.Rule = "YehWithHamzaAbove", .Match = "((?<!" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + ")" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "|(?<!" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterAlef) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicSukun) + ")" + MakeUniRegEx(ArabicLetterHamza) + ")(?=" + MakeUniRegEx(ArabicKasra) + "|" + MakeUniRegEx(ArabicDamma) + "|" + MakeUniRegEx(ArabicFatha) + "|" + MakeUniRegEx(ArabicFathatan) + ")(?! |$)", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterYehWithHamzaAbove)}, _
        New RuleTranslation With {.Rule = "YehWithHamzaAbove", .Match = "(?<=" + MakeUniRegEx(ArabicLetterAlef) + ")" + MakeUniRegEx(ArabicLetterHamza) + MakeUniRegEx(ArabicKasra) + "(?=" + MakeUniRegEx(ArabicLetterYeh) + ")|(?<! |^)" + MakeUniRegEx(ArabicLetterAlefWithHamzaBelow) + MakeUniRegEx(ArabicKasra) + MakeUniRegEx(ArabicLetterYeh) + "(?! |$|" + MakeUniRegEx(ArabicLetterMeem) + ")", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterYehWithHamzaAbove) + CStr(ArabicKasra)}, _
        New RuleTranslation With {.Rule = "Hamza", .Match = MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + "|" + MakeUniRegEx(ArabicLetterSuperscriptAlef) + MakeUniRegEx(ArabicLetterWawWithHamzaAbove), _
