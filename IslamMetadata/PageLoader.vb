...
Public Class Arabic
    ...
    Public Shared SimpleEnhancedScript As RuleTranslation() = { _
        ...
        New RuleTranslation With {.Rule = "SmallSadAboveHamzaWasl", .Match = MakeUniRegEx(ArabicLetterAlefWasla), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterAlef)}, _
        New RuleTranslation With {.Rule = "Alef", .Match = "(?<=^| )(?=" + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicSukun) + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + ")|(?<=(^| )(" + MakeUniRegEx(ArabicLetterWaw) + "|" + MakeUniRegEx(ArabicLetterFeh) + ")" + MakeUniRegEx(ArabicFatha) + ")(?=" + MakeUniRegEx(ArabicLetterSeen) + MakeUniRegEx(ArabicSukun) + ")|(?<=" + MakeUniRegEx(ArabicSukun) + "(" + MakeUniRegEx(ArabicLetterReh) + "|" + MakeUniRegEx(ArabicLetterLam) + ")" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterTeh) + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterAlefMaksura) + MakeUniRegEx(ArabicLetterSuperscriptAlef) + MakeUniRegEx(ArabicMaddahAbove) + "?(?=($| ))|(?<=" + MakeUniRegEx(ArabicLetterAin) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicSukun) + "|" + MakeUniRegEx(ArabicShadda) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterHamza) + MakeUniRegEx(ArabicDamma) + MakeUniRegEx(ArabicLetterWaw) + ")(?= |$)|" + MakeUniRegEx(ArabicLetterWaw) + MakeUniRegEx(ArabicLetterSuperscriptAlef) + MakeUniRegEx(ArabicLetterAlef) + MakeUniRegEx(ArabicSmallHighRoundedZero) + "(?=$| )", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicLetterAlef)}, _
        ...
        New RuleTranslation With {.Rule = "HamzaAlefEnding", .Match = "(" + MakeUniRegEx(ArabicLetterHamza) + "|" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + ")" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterAlef) + "(?=($| ))", _
        ...
        New RuleTranslation With {.Rule = "AlefMaksura", .Match = "(?<=((?<!" + MakeUniRegEx(ArabicLetterLam) + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterGhain) + "|" + MakeUniRegEx(ArabicLetterSad) + "|" + MakeUniRegEx(ArabicLetterHamza) + ")" + MakeUniRegEx(ArabicFatha) + ")" + MakeUniRegEx(ArabicLetterAlef) + "(?=($| ))", _
        ...
        New RuleTranslation With {.Rule = "NonReadYeh", .Match = "(?<=" + MakeUniRegEx(ArabicLetterYeh) + MakeUniRegEx(ArabicSukun) + "|" + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterFeh) + (ArabicFatha) + MakeUniRegEx(ArabicLetterAlefWithHamzaBelow) + MakeUniRegEx(ArabicKasra) + ")" + MakeUniRegEx(ArabicLetterYeh), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) String.Empty}, _
        ...
        New RuleTranslation With {.Rule = "Fatha", .Match = "(?<=" + MakeUniRegEx(ArabicLetterNoon) + MakeUniRegEx(ArabicFatha) + MakeUniRegEx(ArabicLetterJeem) + ")" + MakeUniRegEx(ArabicFathatan) + "(?=" + MakeUniRegEx(ArabicLetterAlef) + "( |$))", _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicFatha)}
        } '+ "|(?<=" + MakeUniRegEx(ArabicTatweel) + MakeUniRegEx(ArabicHamzaAbove) + MakeUniRegEx(ArabicFathatan) + ")" 
    Public Shared SimpleScript As RuleTranslation() = { _
        New RuleTranslation With {.Rule = "RemoveShadda", .Match = MakeUniRegEx(ArabicShadda), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) String.Empty}, _
        New RuleTranslation With {.Rule = "AddSukun", .Match = String.Empty, _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) CStr(ArabicSukun)}
    }
