...
Public Class Arabic
    ...
    Public Shared SimpleMinimalScript As RuleTranslation() = { _
        New RuleTranslation With {.Rule = "RemoveLongVowelDiacritics", .Match = MakeUniRegEx(ArabicShadda) + "|" + MakeRegMultiEx(ArabicLongVowels), _
            .Evaluator = Function(Match As System.Text.RegularExpressions.Match) String.Empty}
    }
