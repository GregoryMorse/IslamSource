...
Public Class TanzilReader
    ...
    Public Shared Sub CheckMutualExclusiveRules(bAssumeContinue As Boolean)
        ...
        Check = {{CachedData.GetPattern("Yehs"), "yeh"}, {"NotYeh", ""}, {"", ""}, {"", ""}, {"", ""}}
        Check = {{CachedData.GetPattern("Waws"), "waw"}, {"NotWaw", ";waw;;waw;optionalnotstop;optionalnotstop;;optionalstop;optionalstop;waw"}, {"MaddWaw", ";waw"}, {"LeenWaw", ";waw;optionalstop;optionalstop;;optionalnotstop;optionalnotstop;waw"}, {"StrongWaw", ";optionalnotstop;optionalnotstop;waw;;waw;;waw;;waw;;optionalstop;optionalstop;waw"}}
        Dim IndexToVerse As Integer()() = Nothing
        Dim Text As String = QuranTextCombiner(IndexToVerse)
