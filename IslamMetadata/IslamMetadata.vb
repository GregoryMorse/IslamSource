...
Public Class Arabic
    ...
    Public Shared Function IntParseFast(value As String) As Integer
        ...
        For i As Integer = If(value.Chars(0) = "-"c, 1, 0) To length - 1
            result = 10 * result + Convert.ToInt32(value.Chars(i)) - 48
        Next
        Return If(value.Chars(0) = "-"c, -result, result)
    End Function
    Public Shared Function GetCacheMetarules(Lines As String(), IndexToVerse As Integer()()) As Generic.List(Of RuleMetadata)
        ...
        For Count As Integer = 0 To Lines.Length - 1
            ...
            Vals = SelectSplit(Value, ","c, sepList, Function(Item) If(Item Is Nothing Or Item = String.Empty, {}, SelectSplit(Item, ":"c, sepListIn, Function(Frag) IntParseFast(Frag))))
            For VerseCount = 0 To Vals.Length - 1
                Idx = Array.BinarySearch(IndexToVerse, New Integer() {Vals(VerseCount)(0), Vals(VerseCount)(1), Vals(VerseCount)(2)}, QWCVWComp)
