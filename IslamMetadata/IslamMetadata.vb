...
Public Class Arabic
    ...
    Public Shared Function GetMetarulesFromCache(ArabicString As String, BasePosition As Integer, Rules As Generic.List(Of RuleMetadata)) As Generic.List(Of RuleMetadata)
        ...
        Return New List(Of RuleMetadata)(Linq.Enumerable.Reverse(New List(Of RuleMetadata)(Linq.Enumerable.TakeWhile(New List(Of RuleMetadata)(Linq.Enumerable.Skip(New List(Of RuleMetadata)(Linq.Enumerable.Reverse(Rules)), Rules.Count - Index)), Function(Item) Item.Index < BasePosition + ArabicString.Length))))
