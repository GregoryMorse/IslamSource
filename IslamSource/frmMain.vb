...
Public Class frmMain
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim IndVerses As String() = TanzilReader.QuranTextRangeLookup(2, 4, 0, 2, 0, 0)(0)
        Debug.Print(Arabic.TransliterateToScheme(IndVerses(0), ArabicData.TranslitScheme.RuleBased, "PlainRoman", TanzilReader.GenerateDefaultStops(Text)))
        ...
        Arabic.TransliterateToScheme(Arabic.TransliterateFromBuckwalter("bihi."), ArabicData.TranslitScheme.LearningMode, "PlainRoman", TanzilReader.GenerateDefaultStops(Arabic.TransliterateFromBuckwalter("bihi.")))
